'use strict';
// Banco Central de Costa Rica exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bccr';
...
/** Latest rate for one pair, e.g. getRate('USD', 'CRC', { apiKey }). */
